...
- Left for worker B: his 9 heroes' rows (Thanos×7 rows incl. DISABLED_ABILITIES rule, Kratos×3, Reinhard×5+, Raiden 1, CaptainAmerica/etc.) per the same old table.
