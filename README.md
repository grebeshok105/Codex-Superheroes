...
- Рабочая версия: `3.12.2` в `gradle.properties`
- База worktree: tag `v3.12.2`, branch `work/v3.12.2`
- Minecraft: `1.21`
...
Сейчас в коде `v3.12.2` зарегистрированы 13 героев: Homelander, Iron Man, Regulus, Sung Jin-Woo, Doomsday, Goku, Naruto, Captain America, Kratos, Loki, Thanos, Reinhard van Astrea и Raiden Shogun.
...
- Работать в этой папке, если нужна база `v3.12.2`: `F:\WorkFLow\TestimCodex\grebeshok105-v3.12.2`.
