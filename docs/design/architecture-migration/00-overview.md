...
**Решение владельца принято:** R14 — новый корневой пакет `io.github.grebeshok105.codex` (подтверждено владельцем 2026-09-26). Остальные стадии от имени не зависят; барьер E1 закрыт по этой части.
