package io.github.grebeshok105.codex.horde.entity;
...
public final class HordeEntities {
	...
	public static final EntityType<io.github.grebeshok105.codex.horde.entity.projectile.HordeAcidBombEntity> ACID_BOMB =
			register("horde_acid_bomb",
					EntityType.Builder.<io.github.grebeshok105.codex.horde.entity.projectile.HordeAcidBombEntity>of(
									io.github.grebeshok105.codex.horde.entity.projectile.HordeAcidBombEntity::new, MobCategory.MISC)
							.sized(0.35f, 0.35f).clientTrackingRange(8).updateInterval(4));
	public static final EntityType<io.github.grebeshok105.codex.horde.entity.projectile.HordeFireBombEntity> FIRE_BOMB =
			register("horde_fire_bomb",
					EntityType.Builder.<io.github.grebeshok105.codex.horde.entity.projectile.HordeFireBombEntity>of(
									io.github.grebeshok105.codex.horde.entity.projectile.HordeFireBombEntity::new, MobCategory.MISC)
							.sized(0.35f, 0.35f).clientTrackingRange(8).updateInterval(4));
