...
/**
 * Stalker — fast, stealthy, applies Slowness on hit. Ambush predator.
 */
public class HordeStalkerEntity extends BaseHordeEntity {
	public HordeStalkerEntity(EntityType<? extends HordeStalkerEntity> type, Level level) {
		super(type, level);
	}
