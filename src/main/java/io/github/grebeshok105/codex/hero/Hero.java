...
public interface Hero {
	 ...
	 */
	default io.github.grebeshok105.codex.physics.ImpactStyle getImpactStyle() {
		return io.github.grebeshok105.codex.physics.ImpactStyle.DEFAULT;
	}
	 ...
	 */
	default boolean canUseAbility(ServerPlayer player, io.github.grebeshok105.codex.transform.HeroData data,
	 ...
	 */
	default boolean isAbilitySuppressedBy(io.github.grebeshok105.codex.transform.HeroData data,
			ResourceLocation abilityId) {
		return false;
	}
