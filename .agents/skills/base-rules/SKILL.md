...
- Можно создавать и обновлять `.md` планы/доки, когда это нужно для задачи; не плодить пустые документы без пользы.
...
- Текущую версию смотреть в `gradle.properties`.
- Для работы с актуальной Codex-базой используй `F:\WorkFLow\TestimCodex\grebeshok105-v3.12.2`, а не `grebeshok105`.
