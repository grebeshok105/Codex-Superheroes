...
Это Fabric-мод `superheroes` для Minecraft `1.21` на Java 21. Текущая база рабочей папки `grebeshok105-v3.12.2`: версия `3.14.0`, package `com.example.superheroes`, official Mojang mappings, Fabric Loader `0.19.2`, Fabric API `0.102.0+1.21`, GeckoLib `4.5.8`.
